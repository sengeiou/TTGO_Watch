...
void EPD4INC::EPD_SetFount( FONT font_index)
{
  ...
  switch (font_index)
  {
    ...
    case 1: Epd_Font.Fontname_En = "/fonten8.bin";       Epd_Font.Fontname_Cn = "/fontcn8.bin";     f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 8; Epd_Font.cn_py = 8; Epd_Font.en_px = 4; Epd_Font.en_py = 8; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 1; break;
//  case 2: Epd_Font.Fontname_En = "/fonten15.bin";       Epd_Font.Fontname_Cn = "\0";              f = SPIFFS.open(Epd_Font.Fontname_En, "r");   Epd_Font.cn_px = 15; Epd_Font.cn_py = 15; Epd_Font.en_px = 8; Epd_Font.en_py = 15; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 2; break;
