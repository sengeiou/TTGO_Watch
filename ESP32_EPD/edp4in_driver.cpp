...
void EPD4INC::EPD_SetFount( FONT font_index)
{
  ...
  switch (font_index)
  {
    // case 0: Epd_Font.Fontname_En = "/fonten12.bin";       Epd_Font.Fontname_Cn = "/fontcn12.bin";   f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 12; Epd_Font.cn_py = 12; Epd_Font.en_px = 6; Epd_Font.en_py = 12; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 0; break;
    case 0: Epd_Font.Fontname_En = "/fonten12_Batang.bin";       Epd_Font.Fontname_Cn = "/fontcn12.bin";   f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 12; Epd_Font.cn_py = 12; Epd_Font.en_px = 7; Epd_Font.en_py = 12; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 0; break;
    case 1: Epd_Font.Fontname_En = "/fonten8_Miriam.bin";       Epd_Font.Fontname_Cn = "/fontcn8.bin";     f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 8; Epd_Font.cn_py = 8; Epd_Font.en_px = 4; Epd_Font.en_py = 8; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 1; break;
    // case 1: Epd_Font.Fontname_En = "/fontcn10_heiti.bin";       Epd_Font.Fontname_Cn = "/fonten10_heiti.bin";     f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 10; Epd_Font.cn_py = 10; Epd_Font.en_px = 6; Epd_Font.en_py = 10; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 1; break;
    // case 2: Epd_Font.Fontname_En = "/fontcn10_heiti.bin";       Epd_Font.Fontname_Cn = "/fonten10_heiti.bin";  f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 10; Epd_Font.cn_py = 10; Epd_Font.en_px = 6; Epd_Font.en_py = 10; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 2; break;
    case 3: Epd_Font.Fontname_En = "/fonten16.bin";       Epd_Font.Fontname_Cn = "/dx_huawenxinwei_16.bin";   f = SPIFFS.open(Epd_Font.Fontname_Cn, "r");   Epd_Font.cn_px = 16; Epd_Font.cn_py = 16; Epd_Font.en_px = 8; Epd_Font.en_py = 16; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 3; break;
    ...
    case 8: Epd_Font.Fontname_En = "/dx_digital_48.bin";  Epd_Font.Fontname_Cn = "\0";              f = SPIFFS.open(Epd_Font.Fontname_En, "r");   Epd_Font.cn_px = 24; Epd_Font.cn_py = 48;   Epd_Font.en_px = 24; Epd_Font.en_py = 48; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 8; break;
    ...
    case 10: Epd_Font.Fontname_En = "/icon12.bin";    Epd_Font.Fontname_Cn = "\0";               f = SPIFFS.open(Epd_Font.Fontname_En, "r");     Epd_Font.cn_px = 0; Epd_Font.cn_py = 0;    Epd_Font.en_px = 12; Epd_Font.en_py = 12; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 10; break;
    case 11: Epd_Font.Fontname_En = "/icon16.bin";    Epd_Font.Fontname_Cn = "\0";               f = SPIFFS.open(Epd_Font.Fontname_En, "r");    Epd_Font.cn_px = 0; Epd_Font.cn_py = 0;    Epd_Font.en_px = 16; Epd_Font.en_py = 16; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 11; break;
    case 12: Epd_Font.Fontname_En = "/icon32.bin";    Epd_Font.Fontname_Cn = "\0";               f = SPIFFS.open(Epd_Font.Fontname_En, "r");    Epd_Font.cn_px = 0; Epd_Font.cn_py = 0;    Epd_Font.en_px = 32; Epd_Font.en_py = 32; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 12; break;
    case 13: Epd_Font.Fontname_En = "/icon48.bin";    Epd_Font.Fontname_Cn = "\0";               f = SPIFFS.open(Epd_Font.Fontname_En, "r");   Epd_Font.cn_px = 0; Epd_Font.cn_py = 0;    Epd_Font.en_px = 48; Epd_Font.en_py = 48; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 13; break;
    case 14: Epd_Font.Fontname_En = "/icon64.bin";    Epd_Font.Fontname_Cn = "\0";               f = SPIFFS.open(Epd_Font.Fontname_En, "r");  Epd_Font.cn_px = 0; Epd_Font.cn_py = 0;    Epd_Font.en_px = 64; Epd_Font.en_py = 64; Epd_Font.part_dx = 1; Epd_Font.Font_Index = 14; break;
...
uint16_t EPD4INC::DrawUnicodeChar(int16_t x, int16_t y,  unsigned char *code, unsigned char isinv)
{
  ...
  char fontbuf[sizeofsinglechar];
 
  
  f.seek(offset, SeekSet);
  f.readBytes(fontbuf, sizeofsinglechar);


  
  // f.close();
  //  Serial.print("\nDrawUnicodeChar load font data over \n");
  ...
  if ((charcode < 0x80) && (Epd_Font.Font_Index < 6)) //字库种英文字符为方块，此处更新
  {
