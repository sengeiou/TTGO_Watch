...
//Arduino_DataBus *bus = new Arduino_HWSPI(TFT_DC, TFT_CS);  //20210201-DX
...
// ILI9341 LCD 240x320
//Arduino_ILI9341 *gfx = new Arduino_ILI9341(bus, TFT_RST, 0 /* rotation */);  //20210201-DX
...
//--------------------DX---------------------------
//Arduino_ESP32SPI_DMA *bus = new Arduino_ESP32SPI_DMA(17 /* DC */, 15 /* CS */, SCK, MOSI, MISO);
//Arduino_ESP32SPI_DMA *bus = new Arduino_ESP32SPI_DMA(17 /* DC */, 15 /* CS */, 14, 13, 12);
//Arduino_ILI9341 *gfx = new Arduino_ILI9341(bus, 16 /* RST */, 3 /* rotation */);

// General software SPI
// Arduino_DataBus *bus = new Arduino_SWSPI(TFT_DC, TFT_CS, 18 /* SCK */, 23 /* MOSI */, -1 /* MISO */);
Arduino_DataBus *bus = new Arduino_SWSPI(17, 15, 14 /* SCK */, 13 /* MOSI */, 12 /* MISO */);
Arduino_ILI9341 *gfx = new Arduino_ILI9341(bus, 16 /* RST */, 3 /* rotation */);
